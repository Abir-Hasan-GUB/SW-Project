    ...
    return (
        ...
        <div className="row mx-0">
            ...
            <div className="col-md-9 dashBoardMainDiv px-0" style={{ height: '700px', backgroundColor: '#dadadb'}}>
                ...
                <h5 className="text-primary py-2">GIVE A FEEDBACK</h5>
                        <div className="col-md-11 p-3 bg-light my-3 makeAdminDiv pr-0 pl-0">
                           ...
                           <div className="row">
                                <div className="col-md-12">
                                    ...
                                    <div className="form-group">
                                        <h6><label htmlFor="description">Your Comments</label></h6>
                                        <textarea className="form-control form-control-lg" name="" placeholder="Type Your Comments" id="description" cols="30" rows="5"  rounded required></textarea>
                           ...
                           <input className="btn btn-success btn-lg btn-block w-75" type="submit" value="Send"/>
                           </div>
                           </form>
                        </div>
                    </div>
